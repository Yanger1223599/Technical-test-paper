...
public class MemberController {
    ...
    @GetMapping("/{memberId}")
    public ResponseEntity<MemberDto> getByMemberId(@PathVariable String memberId) {
        return memberService.getSimpleByMemberId(memberId)
    ...
    public ResponseEntity<MemberDto> getByMemberIdAlt(@PathVariable String memberId) {
